...
const NODE_INFO = {
    enemy: { icon: 'fas fa-dice-d6', name: '普通敌人', desc: '一场标准的牌局挑战。战胜他们以获得奖励。' },
    elite: { icon: 'fas fa-crown', name: '精英敌人', desc: '一个强大的对手，拥有特殊能力。风险与回报并存。' },
    rest: { icon: 'fas fa-coffee', name: '休息处', desc: '一个喘息的机会。你可以选择恢复生命或升级卡牌。' },
    shop: { icon: 'fas fa-store', name: '商店', desc: '使用你在牌局中赢得的筹码购买强大的道具或特殊卡牌。' },
    event: { icon: 'fas fa-question', name: '未知事件', desc: '前方充满了未知。机遇还是陷阱？只有去了才知道。' },
